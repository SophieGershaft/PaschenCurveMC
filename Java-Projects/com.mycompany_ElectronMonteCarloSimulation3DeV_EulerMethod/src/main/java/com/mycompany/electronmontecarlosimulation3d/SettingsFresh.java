...
public class SettingsFresh {
    ...
    public static SettingsFresh instance = null;
    ...
    private SettingsFresh() {
    }

    public static SettingsFresh getInstance() {
        if (instance == null) {
            instance = new SettingsFresh();
        }
        return instance;
    }
    ...
    public static void fromJSON(String fileName) throws IOException {
        ...
        try ( BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
            ...
            instance = gson.fromJson(reader, SettingsFresh.class);
        }
    }
}
